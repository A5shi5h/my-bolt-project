...
<div className="flex justify-center mt-12">
  <div className="max-w-3xl bg-white p-8 rounded-2xl shadow-lg flex flex-col items-center justify-center relative">
    ...
    <img 
      src="https://scontent.fdel29-1.fna.fbcdn.net/v/t39.30808-6/260775671_4180284098743458_2708913666812988485_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=6ee11a&_nc_ohc=mtl8o-Qy6nAQ7kNvgHU_yK_&_nc_zt=23&_nc_ht=scontent.fdel29-1.fna&_nc_gid=Aas1mphZOstUmH5qkVv8Ye2&oh=00_AYBKy2EbjQbJ2f5yQ94Zf4gs31yQwBkhdSZVHwKWitxT7Q&oe=67A3834E" 
      alt="Owner" 
